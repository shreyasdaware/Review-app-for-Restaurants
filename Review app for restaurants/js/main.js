...
navigator.serviceWorker.register('/sw.js',{scope:'/'}).then(function(sw){
  console.log("Worker Registration Sucessful");
}).catch(function(sw){
  console.log("Worker Registration Unsucessful");
  console.log(sw);
})
...
initMap = () => {
  ...
  L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.jpg70?access_token={mapboxToken}', {
    mapboxToken: 'pk.eyJ1Ijoic2Vlbml2YXNhbnNlZW5pIiwiYSI6ImNqbmZ2YzBybjNpdm4zcW1zdWkyYjF6bzUifQ.TTyfTabrNwGkLqFKNkZMiQ',
    maxZoom: 18,
